...
function Signup() {
  ...
  return (
    <div className="App">
      ...
      <form className="form">
      <h1 style={{backgroundColor:"green",color:"white",fontStyle:"italic",borderRadius:"20px",boxShadow:"0px 0px 10px grey"}}>Signup</h1>
        <div>
...
<div>
  <img className="profilePicPreview" src={selectedImage}></img>
</div>
        <div>
